...
This project and everyone participating in it are expected to uphold the [Tribute's Code of Conduct](https://github.com/TheTributeCommunity/fesbal-backend/blob/main/CODE_OF_CONDUCT.md), based on the Covenant Code of Conduct.
